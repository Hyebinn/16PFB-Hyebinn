...
print(" 3. 1==1 and 2==1 = %s" % ((1 == 1 )and (2 == 2)))
...
print(" 20. 3==3 and not('testig' == 'testing' or 'Python' == 'Fun' ) = %s" % ((3==3) and not (('testing' == 'testing') or ('Pythonn' == 'Fun'))))
